"""2D blast wave with reflecting boundary conditions (tube simulation)."""
import time
import numpy as np
...
def blast_ic_2d(x, y, p_high=4.0, p_low=0.1, r0=0.2, center_x=0.5, center_y=0.5):
...
def run_tube_reflecting(tEnd=0.3, nx=100, ny=100, plot=True):
    ...
    print(f"Tube simulation completed in {elapsed:.3f} seconds")
...
if __name__ == "__main__":
    run_tube_reflecting(tEnd=0.3, nx=100, ny=100, plot=True)
